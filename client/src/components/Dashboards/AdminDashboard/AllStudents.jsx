    ...
    <div className="w-full h-screen flex flex-col gap-5 items-center justify-center bg-white">
      ...
      <div className="w-96 flex justify-center">
        <button
          ...
          target="_blank"
          download={true}
          className="px-20 py-3 bg-blue-600 hover:bg-blueurio-700 text-white font-bold rounded-xl shadow-xl"
        >
          Download List
        </button>
        <ToastContainer
      ...
      <div className="bg-white px-10 py-5 rounded-xl shadow-xl sm:w-[50%] sm:min-w-[500px] w-full mt-5 max-h-96 overflow-auto">
        <span className="text-black font-bold text-xl">All Students</span>
        <ul role="list" className="divide-y divide-gray-200 text-black">
          {allStudents.length === 0 ?
            "No Students Found"
          :
          allStudents.map((student) => (
            <li className="py-3 px-5 rounded sm:py-4 hover:bg-gray-100 hover:scale-105 transition-all" key={student._id}>
