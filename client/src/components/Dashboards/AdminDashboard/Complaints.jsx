...
function Complaints() {
  ...
  const graph = (
    <div className="flex items-center justify-center md:h-64 h-40 md:w-96 w-full bg-white rounded-xl shadow-xl p-5">
      <Line
        data={{
          labels: [
            new Date(Date.now() - 6 * 24 * 60 * 60 * 1000).toLocaleDateString(
  ...
  return (
    <div className="w-full h-screen flex flex-col gap-10 md:gap-7 pt-32 items-center justify-center overflow-auto bg-white">
      ...
      <div className="flex md:gap-7 flex-wrap justify-center items-center gap-7">
        {graph}
        <div className="bg-white px-10 py-5 rounded-xl shadow-xl w-96 max-h-64 overflow-auto">
